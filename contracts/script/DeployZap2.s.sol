...
/// Deploys the VimenZap2 router (Uniswap v4 + Rialto, stateless, ownerless).
///
///   CONFIRM_DEPLOY=yes forge script script/DeployZap2.s.sol \
///     --rpc-url $RH_RPC --broadcast --private-key $DEPLOY_KEY \
///     --verify --verifier blockscout \
///     --verifier-url https://robinhoodchain.blockscout.com/api
contract DeployZap2 is Script {
    ...
    function run() external {
        ...
        console.log("=== VimenZap2 deploy config ===");
        ...
        vm.startBroadcast();
        VimenZap2 zap = new VimenZap2(IPoolManager(POOL_MANAGER));
        vm.stopBroadcast();

        console.log("VimenZap2 deployed at: %s", address(zap));
